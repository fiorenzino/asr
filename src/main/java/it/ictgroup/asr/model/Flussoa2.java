...
public class Flussoa2 implements Serializable
{
   ...
   {
      if (this.getErr01() != null && !this.getErr01().trim().isEmpty() && this.getErr01().trim().equals(TipologiaERR01FlussoA.NESSUN_ERRORE.getValue()))
         return true;
      if (this.getErr02() != null && !this.getErr02().trim().isEmpty() && this.getErr01().trim().equals(TipologiaERR02FlussoA.NESSUN_ERRORE.getValue()))
         return true;
      if (this.getErr03() != null && !this.getErr03().trim().isEmpty() && this.getErr01().trim().equals(TipologiaERR03FlussoA.NESSUN_ERRORE.getValue()))
         return true;
      if (this.getErr04() != null && !this.getErr04().trim().isEmpty() && this.getErr01().trim().equals(TipologiaERR04FlussoA.NESSUN_ERRORE.getValue()))
         return true;
      if (this.getErr05() != null && !this.getErr05().trim().isEmpty() && this.getErr01().trim().equals(TipologiaERR05FlussoA.NESSUN_ERRORE.getValue()))
         return true;
      if (this.getErr06() != null && !this.getErr06().trim().isEmpty() && this.getErr01().trim().equals(TipologiaERR06FlussoA.NESSUN_ERRORE.getValue()))
         return true;
      if (this.getErr07() != null && !this.getErr07().trim().isEmpty() && this.getErr01().trim().equals(TipologiaERR07FlussoA.NESSUN_ERRORE.getValue()))
         return true;
      if (this.getErr08() != null && !this.getErr08().trim().isEmpty() && this.getErr01().trim().equals(TipologiaERR08FlussoA.NESSUN_ERRORE.getValue()))
         return true;
      if (this.getErr09() != null && !this.getErr09().trim().isEmpty() && this.getErr01().trim().equals(TipologiaERR09FlussoA.NESSUN_ERRORE.getValue()))
         return true;
      if (this.getErr10() != null && !this.getErr10().trim().isEmpty() && this.getErr01().trim().equals(TipologiaERR10FlussoA.NESSUN_ERRORE.getValue()))
         return true;
      return false;
   }
